    ...
    return (
      ...
      : (
        <View style={[styles.container, {width: this.state.width, height: this.state.height}]}>
          ...
          <View style = {{flexDirection: 'row', backgroundColor: '#263238', justifyContent: 'center', alignItems: 'center', height: this.state.height/9}}>
          ...
          <View style={{backgroundColor: '#263238', width: this.state.width, height: this.state.height * (1 - 1/9 - 1/9 - 1/80)}}>
