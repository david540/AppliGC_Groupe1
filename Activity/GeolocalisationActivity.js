...
export default class GeolocalisationActivity extends React.Component {
  ...
  constructor(props){
    ...
    return (
      <View style={{width:_width,height:_height, justifyContent: 'center', alignItems: 'center', backgroundColor: 'blue'}}>
        <Button
          onPress={() => { resetToScreen(navigation, "MainActivity")}}
          title = "Retour"
          color = "blue"
        />
            <Text style={[{color:'white'}, styles.centered_text]}>Vous voilà arrivé sur l'activité de géolocalisation</Text>
      </View>
    );
	}
}
